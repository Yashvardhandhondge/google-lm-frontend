...
const PricingSection: React.FC = () => {
  return (
    <section data-layername="pricing" className="flex flex-col justify-center items-center py-10 w-full bg-slate-50 md:py-32 max-md:max-w-full ">
    <div data-layername="container" className="flex flex-col items-center max-w-full w-[1280px]">
      <div data-layername="secitonHeadlingLevel11" className="flex flex-col text-base text-center max-w-[800px] w-[800px] max-md:max-w-full">
        <div className="flex flex-col items-center w-full max-md:max-w-full">
          <div data-layername="smallEyebrowTagLabelStyle1" className="flex gap-2 items-center font-medium px-2 py-1 text-gray-600  bg-white rounded-full border border-solid shadow border-slate-300">
            ...
            <p data-layername="content" className="self-stretch font-light text-base">
              Pricing
            </p>
          </div>
          ...
          <p data-layername="descrWrapper" className="flex-1 shrink gap-2 pb-10 self-stretch px-24 text-base sm:px-5 mt-4 w-full leading-7 text-gray-400 max-w-[820px] max-md:max-w-full">
